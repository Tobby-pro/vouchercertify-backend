...
async function main() {
  ...
  const vouchers = [
    ...
    { name: "CCIE", vendor: "Cisco", price: 1600.0, description: "Cisco Certified Internetwork Expert" },
    ...
    // CompTIA
{ name: "A+", vendor: "CompTIA", price: 200.0, description: "CompTIA A+ Certification" },
{ name: "A+ Network", vendor: "CompTIA", price: 499.0, description: "CompTIA Network+ Certification" },
{ name: "A+ Cyber", vendor: "CompTIA", price: 499.0, description: "CompTIA Security+ Certification" },
{ name: "Security+", vendor: "CompTIA", price: 474.0, description: "CompTIA Security+ Certification" },
{ name: "CySA+", vendor: "CompTIA", price: 474.0, description: "CompTIA Cybersecurity Analyst" },
{ name: "PenTest+", vendor: "CompTIA", price: 474.0, description: "CompTIA Penetration Tester" },
{ name: "CASP+", vendor: "CompTIA", price: 199.0, description: "CompTIA Advanced Security Practitioner" },
{ name: "Linux+", vendor: "CompTIA", price: 439.0, description: "CompTIA Linux+ Certification" },
{ name: "Cloud+", vendor: "CompTIA", price: 439.0, description: "CompTIA Cloud+ Certification" },
{ name: "Data+", vendor: "CompTIA", price: 304.0, description: "CompTIA Data+ Certification" },
{ name: "DataSystem+", vendor: "CompTIA", price: 439.0, description: "CompTIA DataSystem+ Certification" },
{name: "Tech+", vendor: "CompTIA", price: 174.0, description: "CompTIA Tech+ Certification" },
...
{ name: "Cloud Essentials+", vendor: "CompTIA", price: 174.0, description: "CompTIA Cloud Essentials+ Certification" },
...
{ name: "SecurityX", vendor: "CompTIA", price: 578.0, description: "CompTIA SecurityX Certification" },
{ name: "Soft Skill Essentials", vendor: "CompTIA", price: 99.0, description: "CompTIA Soft Skills Essentials" },
{ name: "Project+", vendor: "CompTIA", price: 439.0, description: "CompTIA Project+ Certification" },
...
{ name: "ITF+", vendor: "CompTIA", price: 174.0, description: "CompTIA IT Fundamentals (ITF+)" },
...
{ name: "DataX", vendor: "CompTIA", price: 578.0, description: "CompTIA Data Scientist" },
{ name: "Network+", vendor: "CompTIA", price: 439.0, description: "CompTIA Network+ Certification" },
{ name: "Microsoft Office Pro", vendor: "CompTIA", price: 169.0, description: "CompTIA Microsoft Office Pro Certification" },
{ name: "Server+", vendor: "CompTIA", price: 439.0, description: "CompTIA Server+ Certification" },
    // AWS
    ...
    { name: 'AWS Certified Security - Specialty', vendor: 'AWS', price: 300, description: 'Validate your knowledge and advanced technical skills in securing workloads and architectures on AWS' },
       // Microsoft
{ name: "GitHub Actions", vendor: "Microsoft", price: 99.0, description: "GitHub Administrator - Intermediate" },
{ name: "GitHub Administration (beta)", vendor: "Microsoft", price: 99.0, description: "GitHub Administrator - Intermediate" },
{ name: "GitHub Advanced Security", vendor: "Microsoft", price: 99.0, description: "GitHub Administrator - Intermediate" },
{ name: "GitHub Copilot", vendor: "Microsoft", price: 99.0, description: "GitHub App Maker - Intermediate" },
{ name: "GitHub Foundations", vendor: "Microsoft", price: 99.0, description: "GitHub Administrator - Beginner" },
{ name: "Microsoft 365 Certified: Administrator Expert", vendor: "Microsoft", price: 165.0, description: "Exam MS-102 - Microsoft 365 Administrator - Advanced" },
{ name: "Microsoft 365 Certified: Collaboration Communications Systems Engineer Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft 365 Administrator - Intermediate" },
{ name: "Microsoft 365 Certified: Endpoint Administrator Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft 365 Administrator - Intermediate" },
{ name: "Microsoft 365 Certified: Fundamentals", vendor: "Microsoft", price: 99.0, description: "Office 365 Administrator - Beginner" },
{ name: "Microsoft 365 Certified: Teams Administrator Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft 365 Administrator - Intermediate" },
{ name: "Microsoft Certified Educator", vendor: "Microsoft", price: 127.0, description: "Windows Business User - Intermediate" },
{ name: "Microsoft Certified: Azure AI Engineer Associate", vendor: "Microsoft", price: 165.0, description: "Azure AI Engineer - Intermediate" },
{ name: "Microsoft Certified: Azure AI Fundamentals", vendor: "Microsoft", price: 99.0, description: "Azure AI Engineer - Beginner" },
{ name: "Microsoft Certified: Azure Administrator Associate", vendor: "Microsoft", price: 165.0, description: "Azure Administrator - Intermediate" },
{ name: "Microsoft Certified: Azure Cosmos DB Developer Specialty", vendor: "Microsoft", price: 165.0, description: "Azure Developer - Intermediate" },
{ name: "Microsoft Certified: Azure Data Fundamentals", vendor: "Microsoft", price: 99.0, description: "Azure Data Engineer - Beginner" },
{ name: "Microsoft Certified: Azure Data Scientist Associate", vendor: "Microsoft", price: 165.0, description: "Azure Data Scientist - Intermediate" },
{ name: "Microsoft Certified: Azure Database Administrator Associate", vendor: "Microsoft", price: 165.0, description: "Azure Database Administrator - Intermediate" },
{ name: "Microsoft Certified: Azure Developer Associate", vendor: "Microsoft", price: 165.0, description: "Azure Developer - Intermediate" },
{ name: "Microsoft Certified: Azure Fundamentals", vendor: "Microsoft", price: 99.0, description: "Azure Administrator - Beginner" },
{ name: "Microsoft Certified: Azure Network Engineer Associate", vendor: "Microsoft", price: 165.0, description: "Azure Network Engineer - Intermediate" },
{ name: "Microsoft Certified: Azure Security Engineer Associate", vendor: "Microsoft", price: 165.0, description: "Azure Security Engineer - Intermediate" },
{ name: "Microsoft Certified: Azure Solutions Architect Expert", vendor: "Microsoft", price: 165.0, description: "Exam AZ-305 - Azure Solution Architect - Advanced" },
{ name: "Microsoft Certified: Azure Virtual Desktop Specialty", vendor: "Microsoft", price: 165.0, description: "Azure Administrator - Intermediate" },
{ name: "Microsoft Certified: Azure for SAP Workloads Specialty", vendor: "Microsoft", price: 165.0, description: "Azure Solution Architect - Intermediate" },
{ name: "Microsoft Certified: Cybersecurity Architect Expert", vendor: "Microsoft", price: 165.0, description: "Exam SC-100 - Microsoft Defender Administrator - Advanced" },
{ name: "Microsoft Certified: DevOps Engineer Expert", vendor: "Microsoft", price: 165.0, description: "Exam AZ-400 - Azure DevOps Engineer - Advanced" },
{ name: "Microsoft Certified: Dynamics 365 Business Central Developer Associate", vendor: "Microsoft", price: 165.0, description: "Dynamics 365 Business Analyst - Intermediate" },
{ name: "Microsoft Certified: Dynamics 365 Business Central Functional Consultant Associate", vendor: "Microsoft", price: 165.0, description: "Dynamics 365 Functional Consultant - Intermediate" },
{ name: "Microsoft Certified: Dynamics 365 Customer Experience Analyst Associate", vendor: "Microsoft", price: 165.0, description: "Dynamics Business Analyst - Intermediate" },
{ name: "Microsoft Certified: Dynamics 365 Customer Service Functional Consultant Associate", vendor: "Microsoft", price: 165.0, description: "Dynamics 365 Functional Consultant - Intermediate" },
{ name: "Microsoft Certified: Dynamics 365 Field Service Functional Consultant Associate", vendor: "Microsoft", price: 165.0, description: "Dynamics 365 Functional Consultant - Intermediate" },
...
{ name: "Microsoft Certified: Dynamics 365 Supply Chain Management Functional Consultant Associate", vendor: "Microsoft", price: 165.0, description: "Dynamics 365 Functional Consultant - Intermediate" },
{ name: "Microsoft Certified: Dynamics 365 Supply Chain Management Functional Consultant Expert", vendor: "Microsoft", price: 165.0, description: "Exam MB-335 - Dynamics 365 Functional Consultant - Advanced" },
{ name: "Microsoft Certified: Dynamics 365: Finance and Operations Apps Developer Associate", vendor: "Microsoft", price: 165.0, description: "Dynamics 365 Developer - Intermediate" },
{ name: "Microsoft Certified: Dynamics 365: Finance and Operations Apps Solution Architect Expert", vendor: "Microsoft", price: 165.0, description: "Exam MB-700 - Dynamics 365 Functional Consultant - Advanced" },
{ name: "Microsoft Certified: Fabric Analytics Engineer Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft Fabric Data Engineer - Intermediate" },
{ name: "Microsoft Certified: Fabric Data Engineer Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft Fabric Data Engineer - Intermediate" },
{ name: "Microsoft Certified: Identity and Access Administrator Associate", vendor: "Microsoft", price: 165.0, description: "Azure Security Engineer - Intermediate" },
{ name: "Microsoft Certified: Information Security Administrator Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft 365 Administrator - Intermediate" },
{ name: "Microsoft Certified: Power Automate RPA Developer Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft Power Platform Developer - Intermediate" },
{ name: "Microsoft Certified: Power BI Data Analyst Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft Power Platform Data Analyst - Intermediate" },
{ name: "Microsoft Certified: Power Platform Developer Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft Power Platform Developer - Intermediate" },
{ name: "Microsoft Certified: Power Platform Functional Consultant Associate", vendor: "Microsoft", price: 165.0, description: "Microsoft Power Platform Functional Consultant - Intermediate" },
{ name: "Microsoft Certified: Power Platform Fundamentals", vendor: "Microsoft", price: 99.0, description: "Microsoft Power Platform App Maker - Beginner" },
{ name: "Microsoft Certified: Power Platform Solution Architect Expert", vendor: "Microsoft", price: 165.0, description: "Exam PL-600 - Dynamics 365 Developer - Advanced" },
{ name: "Microsoft Certified: Security Operations Analyst Associate", vendor: "Microsoft", price: 165.0, description: "Azure Security Operations Analyst - Intermediate" },
{ name: "Microsoft Certified: Security, Compliance, and Identity Fundamentals", vendor: "Microsoft", price: 99.0, description: "Azure Security Engineer - Beginner" },
{ name: "Microsoft Certified: Windows Server Hybrid Administrator Associate", vendor: "Microsoft", price: 165.0, description: "Exam AZ-800, AZ-801 - Microsoft Entra Administrator - Intermediate" },
